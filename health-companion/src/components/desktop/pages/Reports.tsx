  ...
  return (
    <div className="space-y-12 max-w-6xl mx-auto pt-8">
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 uppercase">Clinical Vault</h1>
        <p className="text-gray-500 font-light text-lg">Secure storage and neural analysis of your medical documentation.</p>
      </div>
      ...
      <div className="grid gap-12 lg:grid-cols-[2.5fr_1.5fr]">
        <div className="space-y-8">
          <div className="flex items-center gap-3 border-b border-gray-100 pb-4">
            ...
            <h2 className="text-xl font-bold text-gray-900 uppercase tracking-tighter">Document Registry</h2>
          </div>
