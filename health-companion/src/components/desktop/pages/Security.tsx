  ...
  return (
    <div className="relative min-h-screen">
      ...
      <main className="pt-40 px-6 pb-32">
        ...
        <section className="container mx-auto max-w-6xl grid md:grid-cols-3 bg-white/30 backdrop-blur-md rounded-[3rem] border border-gray-100 shadow-2xl overflow-hidden mb-40">
...
function LifecycleStep({ icon, title, desc }: { icon: React.ReactNode; title: string; desc: string }) {
  return (
    <div className="p-12 border-r last:border-r-0 border-gray-100/50 hover:bg-white/40 transition-colors">
