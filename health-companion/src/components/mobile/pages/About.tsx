  ...
  return (
    <div className="relative min-h-screen bg-[#FAFAF9] dark:bg-slate-950 flex flex-col">
      ...
      <header className="px-6 py-6 flex items-center gap-4 z-20">
        ...
        <span className="font-bold text-[11px] uppercase tracking-[0.25em] text-gray-400 dark:text-gray-500">Organization</span>
      </header>
      ...
      <main className="flex-1 px-6 pb-24 z-10">
        <div className="space-y-12">
          ...
          <div className="p-8 bg-gray-900 dark:bg-slate-800 rounded-[2.5rem] text-white shadow-2xl space-y-4">
...
function MobileValueRow({ icon, title, desc }: { icon: React.ReactNode; title: string; desc: string }) {
  return (
    <div className="flex items-center gap-5 p-6 bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-white/60 dark:border-slate-700/60 rounded-3xl">
