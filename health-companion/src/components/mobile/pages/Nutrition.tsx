    ...
    <div className="flex flex-col min-h-screen bg-[#FAFAF9]">
      <div className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-2xl border-b border-gray-100 flex items-center justify-between px-6 py-4">
        ...
        <div className="flex flex-col items-center">
          <span className="text-[9px] font-bold uppercase tracking-[0.3em] text-green-600">Nutrition</span>
          <span className="text-[11px] font-bold text-gray-900 uppercase">Advisor</span>
        </div>
          ...
          >
            {quickPrompts.map((item, i) => (
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 bg-white border border-gray-100 rounded-xl hover:border-primary/30 transition-all"
              >
